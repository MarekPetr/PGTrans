# Generated by Django 3.2.6 on 2021-08-16 16:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authority', models.CharField(choices=[('PASSENGER', 'PASSENGER'), ('DRIVER', 'DRIVER')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('OPEN', 'OPEN'), ('CLOSED', 'CLOSED'), ('CANCELED', 'CANCELED'), ('FINISHED', 'FINISHED')], max_length=255)),
                ...
                ('cost', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='CZK', max_digits=10)),
                ('max_passengers', models.IntegerField()),
                ('driver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('vehicle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='transport_reservations.vehicle')),
            ],
        ),
        migrations.CreateModel(
            name='Reservation',
            fields=[
                ...
                ('transport', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='transport_reservations.transport')),
            ],
        ),
        migrations.CreateModel(
            name='Request',
